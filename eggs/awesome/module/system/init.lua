...
-- theme.layout_tile = gears.color.recolor_image(themes_path .. "layouts/tile.png", theme.border_color_active)

local CMD = {
    {
        name = "Lock",
        icon = gears.color.recolor_image(ICON_DIR .. "lock.svg", beautiful.bright),
        cmd = BIN_DIR .. "lock",
    },

    {
        name = "Reboot",
        icon = gears.color.recolor_image(ICON_DIR .. "reboot.svg", beautiful.bright),
        cmd = BIN_DIR .. "reboot",
    },

    {
        name = "Power Off",
        icon = gears.color.recolor_image(ICON_DIR .. "power.svg", beautiful.red),
        cmd = BIN_DIR .. "power",
    },
}
...
local system = wibox.widget({
    {
        {
            image = gears.color.recolor_image(ICON_DIR .. "icon.svg", beautiful.primary),
            resize = true,
            widget = wibox.widget.imagebox,
        },
