...
options.read_options(opts, "subtitleminer")
...
local binary_name = platform == "windows" and "subtitleminer.exe" or "subtitleminer"
local binary_path = utils.join_path(
    utils.join_path(config_folder_path, "bin"),
    binary_name
)
